        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://apps.apple.com/hr/app/taskado-mobile/id6758011921" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-dark-orchid text-white px-6 py-3 rounded-xl hover:bg-dark-orchid/90 transition-colors">
              ...
              <a href="https://play.google.com/store/apps/details?id=tech.knowit.taskadoMobile" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 bg-dark-orchid text-white px-6 py-3 rounded-xl hover:bg-dark-orchid/90 transition-colors">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
